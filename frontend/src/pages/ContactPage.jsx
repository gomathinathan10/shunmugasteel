...
const OFFICES = [
  {
    ...
    phone: '+91-7200240007',
    email: 'enquiry@shunmugasteel.com',
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-8 shadow-sm">
              ...
              {submitted ? (
                <div className="text-center py-10">
                  ...
                  <button onClick={() => { setSubmitted(false); setError(''); setForm({ name: '', email: '', phone: '', subject: '', message: '' }) }} className="mt-6 text-sm font-medium" style={{ color: '#E67E22' }}>
