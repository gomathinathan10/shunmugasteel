...
/* ─── Static data ─── */
const CATEGORIES = [
  { name: 'CR Coils', slug: 'flat-products', image: CDN('0-25mm-cold-rolled-coil-1000x1000cf88.webp'), count: '20 Products' },
  ...
  { name: 'Galvanized Decking Sheets', slug: 'roofing-products', image: CDN('decking-sheets-17e37.jpg'), count: '32 Products' },
  { name: 'PUF Panels', slug: 'roofing-products', image: CDN('puf-panel.webp'), count: '20 Products' },
  { name: 'GP Slitted Coils', slug: 'flat-products', image: CDN('gp-slit-coil-952cf2f.jpg'), count: '18 Products' },
...
const FLAT_PRODUCTS = [
  { id: 1, slug: 'hot-rolled-coils-sheets', name: 'HR Coil IS 2062 – Hot Rolled Pickled', image: CDN('hot-rolled-coils-sheets-bannerb1f5.jpg'), badge: null, priceNote: 'Bulk Rate Available' },
  { id: 2, slug: 'cold-rolled-coils-sheets', name: 'CR Coil IS 513 – Cold Rolled Steel Coil', image: CDN('images/SST-CR-Coils-2ec0d.png'), badge: null, priceNote: 'Bulk Rate Available' },
  ...
  { id: 5, slug: 'ppgl-colour-coated-coils', name: 'PPGL Colour Coil – Pre-Painted Steel', image: CDN('Color-Coated-Coilsb58b.jpg'), badge: null, priceNote: 'Bulk Rate Available' },
  { id: 6, slug: 'cr-slitted-coils', name: 'CR Slitted Coil – 0.25mm Cold Rolled', image: CDN('0-25mm-cold-rolled-coil-1000x1000cf88.jpg'), badge: 'NEW', priceNote: null },
  { id: 16, slug: 'gp-slitted-coils', name: 'GP Slitted Coils – Galvanized Slit', image: CDN('gp-slit-coil-952cf2f.jpg'), badge: null, priceNote: 'Custom Width' },
]

const ROOFING_PRODUCTS = [
  { id: 4, slug: 'galvanized-corrugated-sheets', name: 'GC Sheet – Galv. Corrugated 0.45mm', image: CDN('galvanized-corrugated-sheets7d36.jpg'), badge: null, priceNote: null },
  { id: 7, slug: 'steel-decking-sheets', name: 'Galvanized Decking Sheet', image: CDN('decking-sheets-17e37.jpg'), badge: null, priceNote: 'Custom Sizes' },
  { id: 8, slug: 'puf-sandwich-panels', name: 'PUF Panel – 40mm Insulated', image: CDN('PUF-Panels8be3.png'), badge: null, priceNote: 'Custom Cut' },
  { id: 9, slug: 'polycarbonate-roofing-sheets', name: 'Polycarbonate Roofing Sheet', image: CDN('polycarbonate-sheets-1b014.jpg'), badge: 'NEW', priceNote: null },
  { id: 10, slug: 'upvc-roofing-sheets', name: 'UPVC Roofing Sheet', image: CDN('UPVC-Sheet46e3.jpg'), badge: null, priceNote: 'Min. Order: 1 MT' },
  { id: 12, slug: 'z-c-purlin', name: 'Z & C Purlin', image: CDN('purlinc517.jpg'), badge: null, priceNote: 'Custom Cut' },
  { id: 14, slug: 'turbo-ventilator', name: 'Turbo Ventilator', image: CDN('Turbo-Fan12e6.jpg'), badge: null, priceNote: null },
]

const ACCESSORIES_PRODUCTS = [
  { id: 13, slug: 'roofing-screws', name: 'Roofing Screws & Fasteners', image: CDN('screws1580.jpg'), badge: null, priceNote: null },
  { id: 14, slug: 'turbo-ventilator', name: 'Turbo Ventilator', image: CDN('Turbo-Fan12e6.jpg'), badge: null, priceNote: null },
  { id: 15, slug: 'roofing-accessories', name: 'Roofing Accessories', image: CDN('roofing-accessories-types0572.jpg'), badge: null, priceNote: null },
  { id: 12, slug: 'z-c-purlin', name: 'Z & C Purlin', image: CDN('purlinc517.jpg'), badge: null, priceNote: 'Custom Cut' },
]

const SECOND_SWIPER_PRODUCTS = [
  { id: 11, slug: 'polycarbonate-roofing-sheets', name: 'Polycarbonate Roofing Sheet', image: CDN('polycarbonate-sheets-1b014.jpg'), badge: null, priceNote: 'Bulk Rate Available' },
  { id: 6, slug: 'gp-slitted-coils', name: 'GP Sheet IS277 – Galvanized Plain Sheet 0.5mm', image: CDN('gp-slit-coil-952cf2f.jpg'), badge: 'sale', priceNote: 'Min. Order: 500 kg' },
  { id: 7, slug: 'cr-slitted-coils', name: 'CR Slitted Coil – Cold Rolled', image: CDN('0-25mm-cold-rolled-coil-1000x1000cf88.jpg'), badge: 'NEW', priceNote: null },
  { id: 4, slug: 'hot-rolled-coils-sheets', name: 'HR Coil IS 2062 – Hot Rolled Pickled', image: CDN('hot-rolled-coils-sheets-bannerb1f5.jpg'), badge: null, priceNote: 'Bulk Rate Available' },
  { id: 5, slug: 'ppgl-colour-coated-coils', name: 'PPGL Colour Coil – Pre-Painted Steel', image: CDN('Color-Coated-Coilsb58b.jpg'), badge: null, priceNote: 'Bulk Rate Available' },
  { id: 8, slug: 'steel-decking-sheets', name: 'Galvalume Decking Sheet', image: CDN('decking-sheets-17e37.jpg'), badge: null, priceNote: 'Custom Sizes' },
  { id: 12, slug: 'z-c-purlin', name: 'Z & C Purlin', image: CDN('purlin-108a6.jpg'), badge: null, priceNote: 'Custom Cut' },
]
...
const TAB_SLUG = { flat: 'flat-products', roofing: 'roofing-products', accessories: 'accessories', specials: 'flat-products' }
const TAB_PRODUCTS_FALLBACK = { flat: FLAT_PRODUCTS, roofing: ROOFING_PRODUCTS, accessories: ACCESSORIES_PRODUCTS, specials: FLAT_PRODUCTS }
const TAB_BANNERS = {
  flat: { img: CDN('galvanized-corrugated-sheets-4a6a8.jpg'), title: 'Top Quality Flat Products', link: '/products/flat-products' },
  roofing: { img: CDN('galvanized-corrugated-sheets-4a6a8.jpg'), title: 'Discover Roofing Solutions', link: '/products/roofing-products' },
  accessories: { img: CDN('galvanized-corrugated-sheets-4a6a8.jpg'), title: 'Top Quality Accessories', link: '/products/accessories' },
  specials: { img: CDN('galvanized-corrugated-sheets-4a6a8.jpg'), title: 'Special Offers', link: '/products/flat-products' },
}
...
export default function Home() {
  ...
  const [tabProducts, setTabProducts] = useState(FLAT_PRODUCTS)
  ...
  useEffect(() => {
    ...
    productService.getCategoryBySlug(slug)
      .then((res) => {
        const raw = res.data?.data?.products || res.data?.products || []
        if (raw.length > 0) {
          setTabProducts(raw.map((p) => ({
            id: p.id,
            slug: p.slug,
            name: p.name,
            image: p.primary_image || (p.image_url ? CDN(p.image_url) : ''),
            badge: p.is_new ? 'NEW' : null,
            priceNote: p.base_price ? `From ₹${Number(p.base_price).toLocaleString('en-IN')}/MT` : null,
          })))
        } else {
          setTabProducts(TAB_PRODUCTS_FALLBACK[activeTab] || FLAT_PRODUCTS)
        }
      })
      .catch(() => setTabProducts(TAB_PRODUCTS_FALLBACK[activeTab] || FLAT_PRODUCTS))
            ...
            <div className="tab-pane active show">
              <div className="wrap-prd">
                ...
                <div className="col-prd-2">
                  {tabLoading ? (
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 200, color: '#999', fontSize: 14 }}>Loading...</div>
                  ) : (
        ...
        <div className="container-full">
          <div className="tf-grid-layout xl-col-3 md-col-2 gap-15">
            ...
            <div className="content order-1 order-md-0">
              ...
              <div className="thumbs-prd">
                <div className="prd-image">
                  <img loading="lazy" width="100" height="100" src={CDN('galvanized-corrugated-sheets7d36.jpg')} alt="GC Sheet" />
                </div>
                <div className="prd-info">
                  <Link to="/product/galvanized-corrugated-sheets" className="info_name text-body-1 link">GC Sheet – Galv. Corrugated 0.45mm</Link>
            ...
            <div className="hover-img4 d-none d-xl-block">
              <div className="img-style4 w-100 h-100">
                <img className="img-cove" width="580" height="580" loading="lazy" src="/cdn/puf-panel.webp" alt="PUF Sandwich Panels" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div>
        <div className="container-full">
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              {/* ── Slide 1 — Galvanized Corrugated Sheets ── */}
              <SwiperSlide>
                <div className="banner-lookbook wrap-lookbook_hover style-2">
                  <img className="img-banner" loading="lazy" width="1920" height="640" src="/shooplook-galvanized.png" alt="Galvanized Roofing Installation" />
                  <LookbookPin top="44%" left="32%" dropstart={false} product={{
                    slug: 'galvanized-corrugated-sheets', name: 'GC Sheets',
                    img: CDN('galvanized-corrugated-sheets7d36.jpg'), price: 'Price on Request', note: 'Min. Order: 500 kg',
                  }} />
                  <LookbookPin top="35%" left="24%" dropstart={false} product={{
                    slug: 'turbo-ventilator', name: 'Turbo Ventilator',
                    img: CDN('Turbo-Fan12e6.jpg'), price: 'Price on Request', note: 'Wind Driven',
                  }} />
                  <LookbookPin top="47%" left="57%" dropstart={false} product={{
                    slug: 'steel-decking-sheets', name: 'Galvanized Decking Sheet',
                    img: CDN('decking-sheets-17e37.jpg'), price: 'Price on Request', note: 'Custom Sizes',
                  }} />
                  <LookbookPin top="62%" left="10%" dropstart={false} product={{
                    slug: 'z-c-purlin', name: 'Z & C Purlin',
                    img: CDN('purlinc517.jpg'), price: 'Price on Request', note: 'Custom Lengths',
                  }} />
                  <LookbookPin top="68%" left="75%" dropstart={false} product={{
              ...
              {/* ── Slide 2 — PUF Sandwich Panels ── */}
              <SwiperSlide>
                <div className="banner-lookbook wrap-lookbook_hover style-2">
                  <img className="img-banner" loading="lazy" width="1920" height="640" src="/shoplook-puf.png" alt="PUF Panel Roofing Installation" />
                  <LookbookPin top="37%" left="40%" dropstart={false} product={{
                  ...
                  <LookbookPin top="18%" left="58%" dropstart={true} product={{
                    slug: 'turbo-ventilator', name: 'Turbo Ventilator',
                    img: CDN('Turbo-Fan12e6.jpg'), price: 'Price on Request', note: 'Wind Driven',
                  }} />
                  <LookbookPin top="48%" left="53%" dropstart={false} product={{
                    slug: 'steel-decking-sheets', name: 'Galvanized Decking Sheet',
                    img: CDN('decking-sheets-17e37.jpg'), price: 'Price on Request', note: 'Custom Sizes',
                  }} />
                  <LookbookPin top="62%" left="22%" dropstart={false} product={{
                    slug: 'z-c-purlin', name: 'Z & C Purlin',
                    img: CDN('purlinc517.jpg'), price: 'Price on Request', note: 'Custom Lengths',
                  }} />
                  <LookbookPin top="15%" left="18%" dropstart={false} product={{
                    slug: 'turbo-ventilator', name: 'Turbo Ventilator',
                    img: CDN('Turbo-Fan12e6.jpg'), price: 'Price on Request', note: 'Wind Driven',
                  }} />
                  <LookbookPin top="69%" left="51%" dropstart={false} product={{
                    slug: 'roofing-screws', name: 'Roofing Screws',
                    img: CDN('screws1580.jpg'), price: 'Price on Request', note: 'Self-Drilling',
                  }} />
                </div>
              ...
              {/* ── Slide 3 — Polycarbonate Roofing Sheets ── */}
              <SwiperSlide>
                <div className="banner-lookbook wrap-lookbook_hover style-2">
                  <img className="img-banner" loading="lazy" width="1920" height="640" src="/shoplook-ploycarbonate.png" alt="Polycarbonate Sheet Installation" />
                  <LookbookPin top="45%" left="38%" dropstart={false} product={{
                    slug: 'polycarbonate-roofing-sheets', name: 'Polycarbonate Sheets',
                    img: CDN('polycarbonate-sheets-1b014.jpg'), price: 'Price on Request', note: 'UV Protected',
                  }} />
                  <LookbookPin top="4%" left="36%" dropstart={false} product={{
                    slug: 'turbo-ventilator', name: 'Turbo Ventilator',
                    img: CDN('Turbo-Fan12e6.jpg'), price: 'Price on Request', note: 'Wind Driven',
                  }} />
                  <LookbookPin top="50%" left="60%" dropstart={false} product={{
                    slug: 'steel-decking-sheets', name: 'Galvanized Decking Sheet',
                    img: CDN('decking-sheets-17e37.jpg'), price: 'Price on Request', note: 'Custom Sizes',
                  }} />
                  <LookbookPin top="60%" left="22%" dropstart={false} product={{
                    slug: 'z-c-purlin', name: 'Z & C Purlin',
                    img: CDN('purlinc517.jpg'), price: 'Price on Request', note: 'Custom Lengths',
                  }} />
                  <LookbookPin top="70%" left="80%" dropstart={false} product={{
                    slug: 'roofing-screws', name: 'Roofing Screws',
                    img: CDN('screws1580.jpg'), price: 'Price on Request', note: 'Self-Drilling',
                  }} />
                </div>
              ...
              {/* ── Slide 4 — UPVC Roofing Sheets ── */}
              <SwiperSlide>
                <div className="banner-lookbook wrap-lookbook_hover style-2">
                  <img className="img-banner" loading="lazy" width="1920" height="640" src="/shoplook-upvc.png" alt="UPVC Sheet Installation" />
                  <LookbookPin top="20%" left="75%" dropstart={false} product={{
                  ...
                  <LookbookPin top="30%" left="86%" dropstart={false} product={{
                    slug: 'turbo-ventilator', name: 'Turbo Ventilator',
                    img: CDN('Turbo-Fan12e6.jpg'), price: 'Price on Request', note: 'Wind Driven',
                  }} />
                  <LookbookPin top="45%" left="38%" dropstart={false} product={{
                  ...
                  <LookbookPin top="10%" left="38%" dropstart={false} product={{
                    slug: 'z-c-purlin', name: 'Z & C Purlin',
                    img: CDN('purlinc517.jpg'), price: 'Price on Request', note: 'Custom Lengths',
                  }} />
                  <LookbookPin top="65%" left="55%" dropstart={false} product={{
                    slug: 'roofing-screws', name: 'Roofing Screws',
                    img: CDN('screws1580.jpg'), price: 'Price on Request', note: 'Self-Drilling',
                  }} />
                </div>
              ...
              <SwiperSlide>
                <div className="banner-lookbook wrap-lookbook_hover style-2">
                  ...
                  <LookbookPin top="56%" left="48%" dropstart={false} product={{
                  ...
                  <LookbookPin top="38%" left="81%" dropstart={false} product={{
                  ...
                  <LookbookPin top="72%" left="88%" dropstart={false} product={{
            ...
            <div className="box-nav-pag" style={{
              ...
              <div className="nav-pag_wrap" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <span className="text-body-1" style={{ fontWeight: 500, minWidth: '40px', textAlign: 'center', whiteSpace: 'nowrap' }}>{lbSlide} / 5</span>
                <button
