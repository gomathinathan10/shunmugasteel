      ...
      <Suspense fallback={<div style={{ minHeight: '60vh' }} />}>
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="flat-products" element={<CategoryPage defaultCategory="flat-products" />} />
            <Route path="flat-product" element={<CategoryPage defaultCategory="flat-products" />} />
            <Route path="roofing-products" element={<CategoryPage defaultCategory="roofing-products" />} />
            <Route path="roofing" element={<CategoryPage defaultCategory="roofing-products" />} />
            <Route path="accessories" element={<CategoryPage defaultCategory="accessories" />} />
            <Route path="accessory" element={<CategoryPage defaultCategory="accessories" />} />
